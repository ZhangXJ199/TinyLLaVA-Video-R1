...
VIDEO_DATA_PATH="/mnt/data/zxj/data/DVD-counting"
VIDEO_PATH="/mnt/data/zxj/data/DVD-counting/train_dvd.jsonl"

MODEL_PATH=/mnt/data/zxj/result/reasoning/TinyLLaVA-Video-Coldstart-16
...
deepspeed --include localhost:0,1,2,3 --master_port 29501 tinyllava/train/train.py \
    ...
    --output_dir /mnt/data/zxj/result/reasoning/llava_video_reason_count \
    --num_train_epochs 1 \
    ...
    --run_name llava_video_reason_count
