...
- It requires about **30 Hours** of training on **8 A100-40G GPUs** under default settings. The training time mainly depends on the number and length of responses.
